      ...
      <div className="container mx-auto px-4 flex flex-row justify-around items-center">
        ...
        <div className="flex justify-center">
          <div className="flex w-full max-w-md">
            ...
            />
            <button className="bg-[#AAFFA9] text-gray-700 px-6 py-2 rounded-r-md hover:bg-[#11FFBD] transition duration-300">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <ul className="text-gray-400">
              ...
              <li className="mb-2"><a href="/resources" className="hover:text-white">Resources</a></li>
              <li className="mb-2"><a href="/community" className="hover:text-white">Community</a></li>
          ...
          <div className=" mb-8 md:mb-0">
            ...
            <ul className="text-gray-400">
              ...
              <li className="mb-2"><a href="/tutorials" className="hover:text-white">Tutorials</a></li>
              <li className="mb-2"><a href="/documentation" className="hover:text-white">Documentation</a></li>
